...
if (!isset($_SESSION['u_name'])) {
		...
		<form action="utils/login.php" method="POST">
			...
			<input type="password" class="w3-bar-item w3-margin w3-right w3-border w3-padding-small" title="password" value="" name="pwd" placeholder="Password">
			<input type="text" class="w3-bar-item w3-margin w3-right w3-border w3-padding-small" title="username" value="" name="username" placeholder="Username">
		</form>';
}
else
{
